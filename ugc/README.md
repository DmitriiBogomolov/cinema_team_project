...
Что получилось:
| Postgres    |             |             |             | Время указано в секундах |            |
| ----------- | ----------- | ----------- | ----------- | ------------------------ | ---------- |
|             | Первый тест | Второй тест | Третий тест | Четвертый тест           | Пятый тест |
| 1 итерация  | 0,019       | 0,004       | 30,507      | 0,321                    | 0,035      |
| 2 итерация  | 0,003       | 0,002       | 28,303      | 0,258                    | 0,022      |
| 3 итерация  | 0,004       | 0,002       | 28,672      | 0,253                    | 0,012      |
| 4 итерация  | 0,004       | 0,003       | 31,545      | 0,262                    | 0,015      |
| 5 итерация  | 0,004       | 0,002       | 31,464      | 0,251                    | 0,015      |
| 6 итерация  | 0,004       | 0,002       | 31,198      | 0,251                    | 0,012      |
| 7 итерация  | 0,004       | 0,002       | 29,581      | 0,256                    | 0,012      |
| 8 итерация  | 0,004       | 0,001       | 33,916      | 0,246                    | 0,012      |
| 9 итерация  | 0,004       | 0,002       | 29,574      | 0,249                    | 0,012      |
| 10 итерация | 0,004       | 0,002       | 33,399      | 0,246                    | 0,012      |
| Среднее     | 0,00540     | 0,00220     | 30,81590    | 0,25930                  | 0,01590    |
|             |             |             |             |                          |            |
| MongoDB     |             |             |             |                          |            |
|             | Первый тест | Второй тест | Третий тест | Четвертый тест           | Пятый тест |
...
На размере шума в 100 миллионов записей обе СУБД показали непозволительное время чтения оценок пользователя (1000 записей из общей таблицы/коллекции). И хотя, производительность PostgreSQL оказалась вдвое (а на меньших объемах - в десятки раз) больше, для поставленной задачи решено было выбрать MongoDB из-за предоставляемых возможностей для горизонтального масштабирования.
