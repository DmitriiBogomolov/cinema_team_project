...
start_all_service:
	docker-compose -f docker-compose/bd.yaml -f docker-compose/services.yaml -f docker-compose/utils.yaml  up -d
stop_all_service:
	docker-compose -f docker-compose/utils.yaml -f docker-compose/services.yaml -f docker-compose/bd.yaml  down -v
