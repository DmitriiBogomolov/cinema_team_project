...
TABLES_INFO = [
    table_to_execute('film_work',        'content', FilmWork,       ('id', 'title', 'description', 'creation_date', 'rating')),
    ...
    table_to_execute('person_film_work', 'content', PersonFilmWork, ('id', 'film_work_id', 'person_id')                      )
]
